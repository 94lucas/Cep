...
fun CepScreen() {
    ...
    //é a responsável por manter o estado da Lista
    var listaCepsState by remember {
        mutableStateOf(listOf<Endereco>())
    }
    var listCepState by remember {
    ...
    Column(
        ...
        Card(
            modifier = Modifier
                ...
                .fillMaxWidth(),
            colors = CardDefaults.cardColors(Color(0xC3B8B9B8)),
            elevation = CardDefaults.elevatedCardElevation(0.1.dp)
            ...
            Column(
                    ...
                    trailingIcon = {
                        IconButton(onClick = {
                            val call = RetrofitFactory()
                                .getCepService().getEnderecoByCep(cep = cepState)
                            call.enqueue(object : Callback<Endereco>{
                                override fun onResponse(
                                    call: Call<Endereco>,
                                    response: Response<Endereco>,
                                ) {
                                    listCepState = response.body()!!
                                }
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    IconButton(onClick = {
                      var call = RetrofitFactory().getCepService()
                        ...
                        call.enqueue(object : Callback<List<Endereco>>{
                            override fun onResponse(
                                ...
                                // Tudo que estiver no corpo da requisição sera passado para
                                //listaCepState
                            ...
                            override fun onFailure(call: Call<List<Endereco>>, t: Throwable) {
                                Log.i("Atenção2", "onResponse ${t.message}")
                            }
        ...
        LazyColumn() {
            ...
            item {
                if (listCepState.cep.isNotEmpty()){
                    CardCep(endereco = listCepState)
                }
            }
        }
